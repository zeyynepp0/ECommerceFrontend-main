...
const HomePage = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <CContainer fluid className="py-4">
      {/* Hero Banner */}
      <CCard className="mb-4 position-relative overflow-hidden border-0" style={{ minHeight: 320 }}>
        <div style={{ position: 'relative', height: 320, background: '#222' }}>
          ...
          <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#fff', background: 'rgba(0,0,0,0.3)' }}>
            <h1 className="fw-bold mb-2" style={{ fontSize: '2.5rem' }}>Yeni Sezon Ürünler Keşfedin</h1>
            <p className="mb-3">%30'a varan indirimler sizi bekliyor</p>
            <CButton color="primary" as={Link} to="/products" className="mb-3 px-4 py-2 fs-5">Alışverişe Başla</CButton>
      ...
      <div className="d-flex justify-content-between align-items-center mb-2">
        ...
        <CButton color="link" as={Link} to="/categories">Tümünü Gör</CButton>
      </div>
      ...
      <div className="d-flex justify-content-between align-items-center mb-2">
        ...
        <CButton color="link" as={Link} to="/products">Tümünü Gör</CButton>
      </div>
      {loading ? (
      ...
      <CCard className="mt-5 bg-warning bg-opacity-25 border-0 text-center">
        <CCardBody>
          <CCardTitle as="h2">Özel Fırsatlar</CCardTitle>
          <CCardText>Seçili ürünlerde ekstra %15 indirim</CCardText>
          <CButton color="warning" as={Link} to="/products?discount=true">Hemen Keşfet</CButton>
        </CCardBody>
      </CCard>
    </CContainer>
  );
